...
export const OrderDetails = () => {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 12312321</DialogTitle>
        <DialogDescription>Detalhes do perdido</DialogDescription>
      </DialogHeader>
