...
test('Order paginate', async ({ page }) => {
  await page.goto('/orders', { waitUntil: 'networkidle' })
...
test('Order filter by orderId', async ({ page }) => {
  await page.goto('/orders', { waitUntil: 'networkidle' })
...
test('Order filter by customer name', async ({ page }) => {
  await page.goto('/orders', { waitUntil: 'networkidle' })
...
test('Order filter by status', async ({ page }) => {
  await page.goto('/orders', { waitUntil: 'networkidle' })
